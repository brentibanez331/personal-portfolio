...
export default function AllProjects() {
    return (
        <div className="mx-60 my-36 relative z-20">
            <h1 className="text-4xl font-semibold">Other Works</h1>
            {/* <div className="flex justify-between mt-14"> */}
            <div className="mt-14 grid grid-cols-3 gap-7">
                {/* SmileIT Inc. */}
                <a href="https://github.com/brentibanez331/PCTC_202" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-80 p-6 rounded-md overflow-hidden flex flex-col justify-between relative transition duration-300 hover:scale-105">
                        <div className="top-0 left-0 w-full absolute">
                            <Image src="/projects/pctc.png" width={500} height={500} alt="SmileIT" className="h-32 object-cover" />
                            <div className="p-6">
                ...
                <a href="https://github.com/Gianheybo/smileit" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-80 p-6 rounded-md overflow-hidden flex flex-col justify-between relative transition duration-300 hover:scale-105">
                        <div className="top-0 left-0 w-full absolute">
                            <Image src="/projects/smileit.png" width={500} height={500} alt="SmileIT" className="h-32 object-cover" />
                            <div className="p-6">
                ...
                {/* Treasure Tide */}
                <a href="https://github.com/brentibanez331/boat-game-fixed" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-80 p-6 rounded-md overflow-hidden flex flex-col justify-between relative transition duration-300 hover:scale-105">
                        <div className="top-0 left-0 w-full absolute">
                            <Image src="/projects/treasuretide.png" width={500} height={500} alt="Treasure Tide" className="h-32 object-cover" />
                            <div className="p-6">
                ...
                <a href="https://github.com/brentibanez331/boat-game-fixed" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-80 p-6 rounded-md overflow-hidden flex flex-col justify-between relative transition duration-300 hover:scale-105">
                        <div className="top-0 left-0 w-full absolute">
                            <Image src="/projects/valtara.png" width={500} height={500} alt="Valtara" className="h-32 object-cover" />
                            <div className="p-6">
                ...
                <a>
                    <div style={{ width: 330 }} className="bg-neutral-950 h-80 p-6 rounded-md overflow-hidden flex flex-col justify-between relative transition duration-300 hover:scale-105">
                        <div className="top-0 left-0 w-full absolute">
                            <Image src="/projects/sidlak.png" width={500} height={500} alt="Sidlak" className="h-32 object-cover" />
                            <div className="p-6">
                ...
                <a href="https://github.com/brentibanez331/gaiji-language-learning" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-80 p-6 rounded-md overflow-hidden flex flex-col justify-between relative transition duration-300 hover:scale-105">
                        <div className="top-0 left-0 w-full absolute">
                            <Image src="/projects/gaiji.png" width={500} height={500} alt="Gaiji" className="h-32 object-cover" />
                            <div className="p-6">
                                <h2 className="text-lg font-bold mb-3.5">Gaiji</h2>
                                <p className="text-sm">A language learning app built using Java with Chatbot and Flashcards. Uses Google Translate API and JFrame GUI.</p>
                            </div>
                            <div className="px-6 flex">
