...
export default function AIMLProjects() {
    return (
        <div className="mx-60 my-36 relative z-20">
            <h1 className="text-4xl font-semibold">Data Science / ML Works</h1>
            <div className="grid grid-cols-3 gap-7 mt-14">
                ...
                <a href="https://github.com/brentibanez331/urinalysis-ph" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                        <div>
                ...
                <a href="https://creativetourism.ph/" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                        <div>
                            ...
                            <p className="text-sm">This repository contains</p>
                        </div>
                        <div className="flex mt-5">
                ...
                {/* Agronex */}
                <a style={{ width: 330 }} href="https://github.com/brentibanez331/plant-disease-classification" target="_blank">
                    <div className="bg-neutral-950 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                        <div>
                            <h2 className="text-lg font-bold mb-3.5">osteoporosis-risk</h2>
                            <p className="text-sm">A classification model for predicting if patient has osteoporosis. Evaluated model performance on LogisticRegression and RandomForest.</p>
                        </div>
                        <div className="flex mt-5">
                            <a href="https://github.com/brentibanez331/plant-disease-classification" target="_blank"><FaCode className="text-xl mr-6 text-neutral-400 hover:text-white transition duration-150" /></a>
                        </div>
                ...
                {/* Urinalysis Diagnosis */}
                <a style={{ width: 330 }} href="https://github.com/brentibanez331/urinalysis-ph" target="_blank">
                    <div className="bg-neutral-950 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                        <div>
                ...
                <a href="https://creativetourism.ph/" target="_blank">
                    <div style={{ width: 330 }} className="bg-neutral-950 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                        ...
                        <div>
                            ...
                            <p className="text-sm">This repository contains a simple CNN architecture, 2 Dense ReLU layers and a linear Dense for predicting 0-9 digits.</p>
                        </div>
                        <div className="flex mt-5">
                            <a href="https://github.com/brentibanez331/PCTC_2023" target="_blank"><FaCode className="text-xl mr-6 text-neutral-400 hover:text-white transition duration-150" /></a>
                        </div>
