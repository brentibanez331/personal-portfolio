...
export default function Featured() {
    return (
        <div className="mx-7 sm:mx-10 my- md:my-36 relative z-20 lg:mx-24">
            <h1 className="text-3xl sm:text-4xl font-semibold">Featured Projects</h1>
            <div className="flex flex-col md:grid sm:justify-between mt-10 md:mt-14 md:grid-cols-3 gap-0.5 sm:gap-0.5 mt-14 md:gap-3">
                <a href="https://github.com/brentibanez331/plant-disease-classification" target="_blank">
                    <div className="bg-[#0E0E10] mb-3.5 md:h-52 lg:h-60 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105 w-full">
                        <div>
                ...
                <a href="https://github.com/brentibanez331/urinalysis-ph" target="_blank">
                    <div className="bg-[#0E0E10] mb-3.5 md:h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105 w-full">
                        <div>
