    ...
    return (
        <div className="mx-60 my-36 relative z-20">
            ...
            <div className="flex justify-between mt-14">
                <div className="bg-neutral-950 w-80 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                    <div>
                    ...
                    <div className="flex mt-5">
                        ...
                        <a href="https://plant-diseases-classifier.vercel.app/" target="_blank"><FaGlobe className="text-xl mr-4 text-neutral-400 hover:text-white transition duration-150" /></a>
                    </div>
                </div>
                <div className="bg-neutral-950 w-80 h-52 p-6 rounded-md flex flex-col justify-between transition duration-300 hover:scale-105">
                    <div>
